<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- <el-form-item label="合作商 ID" prop="partnerId">
        <el-input
          v-model="queryParams.partnerId"
          placeholder="请输入合作商 ID"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item> -->
...
const data = reactive({
  ...
  rules: {
    ...
    businessDistrictType: [{ required: true, message: '商圈类型不能为空', trigger: 'change' }],
    regionId: [{ required: true, message: '区域 ID不能为空', trigger: 'blur' }],
    partnerId: [{ required: true, message: '合作商 ID不能为空', trigger: 'blur' }]
  }
})
